...
# Data
data_root = '/home/ubuntu/public-Datasets/HumanCaption/'
data_path = data_root + 'pt_hfformat'
# data_path = data_root + 'pt_chatformat'
image_folder = data_root + 'pt_images'
...
SYSTEM = ''
evaluation_images = '/home/ubuntu/san/LYT/UniDetRet-exp/HumanLlama3/test.jpg'
evaluation_inputs = ['请描述一下这张照片', 'Please describe this picture', 'how many people are in the picture?']
